...
var getElementRenderer = ({ elementRenderers }, tagName, ceClass = customElements.get(tagName), attributes = new Map()) => {
  ...
  for (const renderer of elementRenderers) {
    if (renderer && renderer.matchesClass(ceClass, tagName, attributes)) {
...
var b = (t4) => (i7, ...s6) => ({ _$litType$: t4, strings: i7, values: s6 });
var T = b(1);
var x = b(2);
...
var H = class {
  ...
  I(t4, i7 = this, s6, e5) {
    ...
    let l4 = false;
    if (o6 === void 0)
      t4 = S2(this, t4, i7, 0), l4 = !d(t4) || t4 !== this.H && t4 !== w, l4 && (this.H = t4);
    else {
      const e6 = t4;
      let n6, h4;
...
var i4 = (t4) => (...i7) => ({ _$litDirective$: t4, values: i7 });
var s5 = class {
  constructor(t4) {
  }
  T(t4, i7, s6) {
...
function* renderValue(value, renderInfo) {
  ...
  if (value != null && v2(value)) {
    ...
    yield `<!--lit-part-->`;
    if (value === void 0 || value === null || value === A || value === w) {
